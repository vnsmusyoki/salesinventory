        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-10 col-sm-8 col-md-5 col-lg-4">
                    ...
                    <p class="phone-no"><i class="anm anm-phone-s"></i> Now open for Deals with you</p>
                </div>
                <div class="col-sm-4 col-md-4 col-lg-4 d-none d-lg-none d-md-block d-lg-block">
                    <div class="text-center">
                        <p class="top-header_middle-text"> Free Shipping</p>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                        ...
                        <ul id="siteNav" class="site-nav medium center hidearrow">
                            ...
                            <li class="lvl1 parent dropdown"><a href="#">Pages <i class="anm anm-angle-down-l"></i></a>
                                <ul class="dropdown">
                                    ...
                                    <li><a href="login.php" class="site-nav">Login</a></li>
                                    <li><a href="register.php" class="site-nav">Create New Account</a></li>
                                </ul>
                            </li>
                ...
                <div class="col-6 col-sm-6 col-md-6 col-lg-2 d-block d-lg-none mobile-logo">
                    <div class="logo">
                        <a href="index.php">
                            <img src="assets/images/logo.svg" alt="Sales Inventory System" title="Sales Inventory System" />
                        </a>
                    </div>
                </div>
                <!--Mobile Logo-->
