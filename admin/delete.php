                    ...
                    <h6 class="dropdown-header d-flex align-items-center">
                        ...
                        <div class="dropdown-user-details">
                            ...
                            <div class="dropdown-user-details-email"><a href="/cdn-cgi/l/email-protection"
                                    class="__cf_email__"
                                    data-cfemail="e0968c958e81a0818f8cce838f8d">[email&#160;protected]</a></div>
                        </div>
                    </h6>
                        ...
                        <div class="page-header-content pt-4">
                            <div class="row align-items-center justify-content-between">
                                <div class="col-auto mt-4">
                                    ...
                                    <div class="page-header-subtitle">Dynamic form components to give your users
                                        informative and intuitive inputs</div>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="sbp-preview">
                                            ...
                                            <div class="sbp-preview-code">
                                                ...
                                                <ul class="nav nav-tabs" id="formsSolidTabs" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active me-1" id="formsSolidHtmlTab"
                                                            data-bs-toggle="tab" href="#formsSolidHtml" role="tab"
                                                            aria-controls="formsSolidHtml" aria-selected="true">
                                                            <i class="fab fa-html5 text-orange me-1"></i>
                                                            HTML
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="formsSolidPugTab" data-bs-toggle="tab"
                                                            href="#formsSolidPug" role="tab"
                                                            aria-controls="formsSolidPug" aria-selected="false">
                                            ...
                                            <div class="sbp-preview-text">
                                                Custom solid form controls have been developed as an alternative to the
                                                default form styling. Use them by appending the
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="sbp-preview mb-4">
                                            <div class="sbp-preview-content">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" id="flexCheckDisabled"
                                            ...
                                            <div class="sbp-preview-code">
                                                ...
                                                <ul class="nav nav-tabs" id="formsCheckboxesTabs" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active me-1" id="formsCheckboxesHtmlTab"
                                                            data-bs-toggle="tab" href="#formsCheckboxesHtml" role="tab"
                                                            aria-controls="formsCheckboxesHtml" aria-selected="true">
                                                            <i class="fab fa-html5 text-orange me-1"></i>
                                                            HTML
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="formsCheckboxesPugTab"
                                                            data-bs-toggle="tab" href="#formsCheckboxesPug" role="tab"
                                                            aria-controls="formsCheckboxesPug" aria-selected="false">
                                                            <img class="img-pug me-1" src="assets/img/demo/pug.svg" />
                                                            PUG
                                                        </a>
                                                    </li>
                                        ...
                                        <div class="sbp-preview">
                                            <div class="sbp-preview-content">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="flexRadioDefault2">Default
                                                        checked radio</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" id="flexRadioDefault3" type="radio"
                                                        name="flexRadioDefault" disabled="" />
                                                    <label class="form-check-label" for="flexRadioDefault3">Default
                                            ...
                                            <div class="sbp-preview-code">
                                                ...
                                                <ul class="nav nav-tabs" id="formsRadioTabs" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active me-1" id="formsRadioHtmlTab"
                                                            data-bs-toggle="tab" href="#formsRadioHtml" role="tab"
                                                            aria-controls="formsRadioHtml" aria-selected="true">
                                                            <i class="fab fa-html5 text-orange me-1"></i>
                                                            HTML
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="formsRadioPugTab" data-bs-toggle="tab"
                                                            href="#formsRadioPug" role="tab"
                                                            aria-controls="formsRadioPug" aria-selected="false">
                                                            <img class="img-pug me-1" src="assets/img/demo/pug.svg" />
                                                            PUG
                                                        </a>
                                                    </li>
                                        ...
                                        <div class="sbp-preview mb-4">
                                            <div class="sbp-preview-content">
                                                <div class="form-check form-check-solid">
                                                    <input class="form-check-input" id="flexCheckSolidDefault"
                                                        type="checkbox" value="" />
                                                    <label class="form-check-label" for="flexCheckSolidDefault">Default
                                                        checkbox</label>
                                                </div>
                                                <div class="form-check form-check-solid">
                                                    <input class="form-check-input" id="flexCheckSolidChecked"
                                                        type="checkbox" value="" checked="" />
                                                    <label class="form-check-label" for="flexCheckSolidChecked">Checked
                                                        checkbox</label>
                                                </div>
                                                <div class="form-check form-check-solid">
                                                    <input class="form-check-input" id="flexCheckSolidDisabled"
                                                        type="checkbox" value="" disabled="" />
                                                    <label class="form-check-label"
                                                        for="flexCheckSolidDisabled">Disabled checkbox</label>
                                                </div>
                                            </div>
                                            <div class="sbp-preview-code">
                                                <!-- Code sample-->
                                                <ul class="nav nav-tabs" id="formsCheckboxesSolidTabs" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active me-1" id="formsCheckboxesSolidHtmlTab"
                                                            data-bs-toggle="tab" href="#formsCheckboxesSolidHtml"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="formsCheckboxesSolidPugTab"
                                                            data-bs-toggle="tab" href="#formsCheckboxesSolidPug"
                                                            role="tab" aria-controls="formsCheckboxesSolidPug"
                                                            aria-selected="false">
                                                            <img class="img-pug me-1" src="assets/img/demo/pug.svg" />
                                                            PUG
                                                        </a>
    ...
    label.form-check-label(for='flexCheckSolidDisabled')
        | Disabled checkbox</code></pre>
                                        ...
                                        <div class="sbp-preview">
                                            <div class="sbp-preview-content">
                                                <div class="form-check form-check-solid">
                                                    <input class="form-check-input" id="flexRadioSolid1" type="radio"
                                                        name="flexRadioSolid" />
                                                    <label class="form-check-label" for="flexRadioSolid1">Default
                                                        radio</label>
                                                </div>
                                                <div class="form-check form-check-solid">
                                                    <input class="form-check-input" id="flexRadioSolid2" type="radio"
                                                        name="flexRadioSolid" checked="" />
                                                    <label class="form-check-label" for="flexRadioSolid2">Default
                                                        checked radio</label>
                                                </div>
                                                <div class="form-check form-check-solid">
                                                    <input class="form-check-input" id="flexRadioSolid3" type="radio"
                                                        name="flexRadioSolid" disabled="" />
                                                    <label class="form-check-label" for="flexRadioSolid3">Default
                                                        disabled radio</label>
                                                </div>
                                            </div>
                                            <div class="sbp-preview-code">
                                                ...
                                                <ul class="nav nav-tabs" id="formsRadioSolidTabs" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active me-1" id="formsRadioSolidHtmlTab"
                                                            data-bs-toggle="tab" href="#formsRadioSolidHtml" role="tab"
                                                            aria-controls="formsRadioSolidHtml" aria-selected="true">
                                                            <i class="fab fa-html5 text-orange me-1"></i>
                                                            HTML
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="formsRadioSolidPugTab"
                                                            data-bs-toggle="tab" href="#formsRadioSolidPug" role="tab"
                                                            aria-controls="formsRadioSolidPug" aria-selected="false">
                                                            <img class="img-pug me-1" src="assets/img/demo/pug.svg" />
                                                            PUG
                                                        </a>
                                                    </li>
                                        ...
                                        <div class="sbp-preview">
                                            <div class="sbp-preview-content">
                                                ...
                                                <div class="input-group input-group-joined mb-4">
                                                    <input class="form-control pe-0" type="text"
                                                        placeholder="Input group append..." aria-label="Search" />
                                                ...
                                                <div class="input-group input-group-joined mb-4">
                                                    ...
                                                    <input class="form-control ps-0" type="text"
                                                        placeholder="Input group prepend..." aria-label="Search" />
                                                </div>
                                            ...
                                            <div class="sbp-preview-code">
                                                ...
                                                <ul class="nav nav-tabs" id="inputGroupJoinedTabs" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active me-1" id="inputGroupJoinedHtmlTab"
                                                            data-bs-toggle="tab" href="#inputGroupJoinedHtml" role="tab"
                                                            aria-controls="inputGroupJoinedHtml" aria-selected="true">
                                                            <i class="fab fa-html5 text-orange me-1"></i>
                                                            HTML
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="inputGroupJoinedPugTab"
                                                            data-bs-toggle="tab" href="#inputGroupJoinedPug" role="tab"
                                                            aria-controls="inputGroupJoinedPug" aria-selected="false">
                                                            <img class="img-pug me-1" src="assets/img/demo/pug.svg" />
                                                            PUG
                                                        </a>
                                                    </li>
                                                ...
                                                <!-- Tab panes-->
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="inputGroupJoinedHtml"
                                                        role="tabpanel" aria-labelledby="inputGroupJoinedHtmlTab">
...
<div class="input-group input-group-joined input-group-solid">
    ...
    <input class="form-control ps-0" type="text" placeholder="Input group prepend..." aria-label="Search">
                                                    ...
                                                    <div class="tab-pane" id="inputGroupJoinedPug" role="tabpanel"
                                                        aria-labelledby="inputGroupJoinedPugTab">
...
.input-group.input-group-joined.input-group-solid
    ...
    input.form-control.ps-0(type='text', placeholder='Input group prepend...', aria-label='Search')</code></pre>
                                            ...
                                            <div class="sbp-preview-text">
                                                ...
                                                CSS pseudo class to join input group appends and prepends within an
                                                input group. Unlike Bootstrap's default input group behavior, these
                                                joined input group variations will focus the entire input group when the
                                                form control within is selected. This variation also removes the
                                                background and border coloring of the append and prepend elements for a
                                                smooth, and seamless input group appearance.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="sbp-preview">
                                            ...
                                            <div class="sbp-preview-code">
                                                ...
                                                <ul class="nav nav-tabs" id="dateRangePickerTabs" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active me-1" id="dateRangePickerHtmlTab"
                                                            data-bs-toggle="tab" href="#dateRangePickerHtml" role="tab"
                                                            aria-controls="dateRangePickerHtml" aria-selected="true">
                                                            <i class="fab fa-html5 text-orange me-1"></i>
                                                            HTML
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="dateRangePickerPugTab"
                                                            data-bs-toggle="tab" href="#dateRangePickerPug" role="tab"
                                                            aria-controls="dateRangePickerPug" aria-selected="false">
                                                            <img class="img-pug me-1" src="assets/img/demo/pug.svg" />
                                                            PUG
                                                        </a>
                                                    </li>
                                                ...
                                                <!-- Tab panes-->
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="dateRangePickerHtml"
                                                        role="tabpanel" aria-labelledby="dateRangePickerHtmlTab">
...
<div class="input-group input-group-joined" style="width: 16.5rem;">
    ...
    <input class="form-control ps-0" id="litepickerRangePlugin" placeholder="Select date range..." />
                                                    ...
                                                    <div class="tab-pane" id="dateRangePickerPug" role="tabpanel"
                                                        aria-labelledby="dateRangePickerPugTab">
...
.input-group.input-group-joined(style='width: 16.5rem;')
    ...
    input.form-control.ps-0.pointer#litepickerRangePlugin(placeholder='Select date range...')</code></pre>
                                            ...
                                            <div class="sbp-preview-text">
                                                <p class="mb-0">
                                                    This plugin is powered by a third party dependency called
                                                    Litepicker. Visit the
                            ...
                            <div class="card card-icon mb-4">
                                <div class="row g-0">
                                    <div class="col-auto card-icon-aside bg-secondary"><i
                                            class="me-1 text-white-50 fab fa-bootstrap"></i></div>
                                    <div class="col">
    ...
    <script defer
        ...
        data-cf-beacon='{"rayId":"6e61fe8328b26c72","token":"6e2c2575ac8f44ed824cef7899ba8463","version":"2021.12.0","si":100}'
        crossorigin="anonymous"></script>
</body>
